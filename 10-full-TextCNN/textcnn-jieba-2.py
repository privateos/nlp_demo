...
class Config(object):
    ...
    def __init__(self, dataset, embedding):
        ...
        self.train_path = dataset + '/data/train_splited.txt'
        #'THUCNews/data/train_splited.txt'
        

        # self.dev_path = dataset + '/data/dev.txt'# 验证集 
        #'THUCNews/data/dev.txt'
        self.dev_path = dataset + '/data/dev_splited.txt'


        # self.test_path = dataset + '/data/test.txt'# 测试集 
        #'THUCNews/data/test.txt'
        self.test_path = dataset + '/data/test_splited.txt'
...
def build_dataset(config, ues_word):#use_word = False
    ...
    if os.path.exists(config.vocab_path):
        ...
        vocab = build_vocab(
            config.train_path, #'THUCNews/data/train.txt'-->'THUCNews/data/train_splited.txt'
    ...
    #'THUCNews/data/train.txt'-->'THUCNews/data/train_splited.txt'

    dev = load_dataset(config.dev_path, config.pad_size)
    #'THUCNews/data/dev.txt'-->'THUCNews/data/dev_splited.txt'

    test = load_dataset(config.test_path, config.pad_size)
    #'THUCNews/data/test.txt'--->'THUCNews/data/test_splited.txt'
    #test = [
